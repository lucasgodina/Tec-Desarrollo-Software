...
# tiene dos dígitos (por ejemplo +34-913724710-56).
# Escribir un programa que pregunte por un número
# de teléfono con este formato y muestre por
# pantalla el número de teléfono sin el prefijo y la
# extensión.
numero = input("Ingrese un numero de telefono con el formato adecuado: ")
